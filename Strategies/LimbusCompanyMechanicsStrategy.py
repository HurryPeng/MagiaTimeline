...
class LimbusCompanyMechanicsStrategy(AbstractFramewiseStrategy):
    ...
    def __init__(self, config, contentRect: AbstractRectangle) -> None:
        ...
        self.iirPasses["iirPassFillGapDialog"] = IIRPassFillGap(LimbusCompanyMechanicsStrategy.FlagIndex.Dialog.name, 500, 1.0)
    ...
    def cvPassDialog(self, frame: cv.Mat, framePoint: FramePoint) -> bool:
        ...
        roiDialogTextBinDilate = cv.morphologyEx(roiDialogTextBin, cv.MORPH_DILATE, kernel=cv.getStructuringElement(cv.MORPH_RECT, (3, 3)))
        roiDialogGrayNoText = cv.bitwise_and(roiDialogGray, roiDialogGray, mask=255-roiDialogTextBinDilate)
