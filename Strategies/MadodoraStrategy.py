...
class MadodoraStrategy(AbstractFramewiseStrategy):
    ...
    def __init__(self, config: dict, contentRect: AbstractRectangle) -> None:
        ...
        self.iirPasses["iirPassFillGapHomeDialog"] = IIRPassFillGap(MadodoraStrategy.FlagIndex.HomeDialog.name, 300, 0.0)
        self.iirPasses["iirPassExtendHomeDialog"] = IIRPassExtend(MadodoraStrategy.FlagIndex.HomeDialog.name, 300, 0)
        self.iirPasses["iirPassFillGapDialog"] = IIRPassFillGap(MadodoraStrategy.FlagIndex.Dialog.name, 300, 0.0)
        self.iirPasses["iirPassExtendDialog"] = IIRPassExtend(MadodoraStrategy.FlagIndex.Dialog.name, 300, 0)
        self.iirPasses["iirPassFillGapWhitescreen"] = IIRPassFillGap(MadodoraStrategy.FlagIndex.Whitescreen.name, 2000, 0.5)
        self.iirPasses["iirPassExtendWhitescreen"] = IIRPassExtend(MadodoraStrategy.FlagIndex.Whitescreen.name, 400, 400)
        self.iirPasses["iirPassFillGapBlackscreen"] = IIRPassFillGap(MadodoraStrategy.FlagIndex.Blackscreen.name, 2000, 0.5)
        self.iirPasses["iirPassExtendBlackscreen"] = IIRPassExtend(MadodoraStrategy.FlagIndex.Blackscreen.name, 400, 400)
        self.iirPasses["iirPassFillGapLeftBubble"] = IIRPassFillGap(MadodoraStrategy.FlagIndex.LeftBubble.name, 300, 0.0)
        self.iirPasses["iirPassExtendLeftBubble"] = IIRPassExtend(MadodoraStrategy.FlagIndex.LeftBubble.name, 200, 0)
        self.iirPasses["iirPassFillGapRightBubble"] = IIRPassFillGap(MadodoraStrategy.FlagIndex.RightBubble.name, 300, 0.0)
        self.iirPasses["iirPassExtendRightBubble"] = IIRPassExtend(MadodoraStrategy.FlagIndex.RightBubble.name, 200, 0)
