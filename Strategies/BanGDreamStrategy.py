...
class BanGDreamStrategy(AbstractStrategy):
    ...
    def __init__(self, config: dict, contentRect: AbstractRectangle) -> None:
        ...
        self.iirPasses["iirPassFillGapDialog"] = IIRPassFillGap(BanGDreamStrategy.FlagIndex.Dialog, 300, meetPoint=0)
    ...
    def cvPassDialog(self, frame: cv.Mat, framePoint: FramePoint) -> bool:
        ...
        hasDialog = meanDialogBinBg > 210 and meanDialogBinText > 1.0 and meanDialogBinText < 25
