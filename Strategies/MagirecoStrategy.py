...
class MagirecoStrategy(AbstractStrategy):
    ...
    def cvPassDialog(self, frame: cv.Mat) -> typing.Tuple[typing.Dict[AbstractFlagIndex, typing.Any], bool]:
        ...
        return { \
            MagirecoStrategy.FlagIndex.Dialog: isValidDialog, \
            MagirecoStrategy.FlagIndex.DialogBg: hasDialogBg, \
            MagirecoStrategy.FlagIndex.DialogText: hasDialogText, \
            MagirecoStrategy.FlagIndex.DialogOutline: hasDialogOutline, \
        }, isValidDialog

    def cvPassBlackscreen(self, frame: cv.Mat) -> typing.Tuple[typing.Dict[AbstractFlagIndex, typing.Any], bool]:
        ...
        return { \
            MagirecoStrategy.FlagIndex.Blackscreen: isValidBlackscreen, \
            MagirecoStrategy.FlagIndex.BlackscreenBg: hasBlackscreenBg, \
            MagirecoStrategy.FlagIndex.BlackscreenText: hasBlackscreenText, \
        }, isValidBlackscreen

    def cvPassWhitescreen(self, frame: cv.Mat) -> typing.Tuple[typing.Dict[AbstractFlagIndex, typing.Any], bool]:
        ...
        return { \
            MagirecoStrategy.FlagIndex.Whitescreen: isValidWhitescreen, \
            MagirecoStrategy.FlagIndex.WhitescreenBg: hasWhitescreenBg, \
            MagirecoStrategy.FlagIndex.WhitescreenText: hasWhitescreenText, \
        }, isValidWhitescreen

    def cvPassCgSub(self, frame: cv.Mat) -> typing.Tuple[typing.Dict[AbstractFlagIndex, typing.Any], bool]:
        ...
        return { \
            MagirecoStrategy.FlagIndex.CgSub: isValidCgSub, \
            MagirecoStrategy.FlagIndex.CgSubContrast: hasCgSubContrast, \
            MagirecoStrategy.FlagIndex.CgSubBorder: hasCgSubBorder, \
            MagirecoStrategy.FlagIndex.CgSubText: hasCgSubText, \
        }, isValidCgSub
